...
[Work in Progress](#work-in-progress){.link-button}
...
::: {.philosophy-note}
**English version.** I take inspiration from von Neumann's view that formal disciplines stay vital when they repeatedly return to their empirical sources. Models, methods, and metrics are most useful when they are replenished by ideas drawn from reality.

**中文版本。** 朱熹说：“问渠哪得清如许，为有源头活水来。” 对我而言，这句诗表达了同样的研究观：学术问题的清澈与生命力，来自对真实运营现场和一手经验的持续回到。
:::
...
::: {.stream-card}
### Content Governance, Trust, and Digital Platforms

This is a developing stream on how platforms govern interactions, information quality, and trust in AI-enabled digital environments. TODO: add specific projects, settings, and papers before presenting this as a mature research stream.
:::
...
TODO: Add published, accepted, or forthcoming papers when available.
:::
...
TODO: Add work-in-progress projects when they are ready to describe publicly. For each project, include title, coauthors, stage, research question, empirical setting, methods, and public status note.
:::
